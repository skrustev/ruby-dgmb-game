...
describe 'GameMode' do
  ...
  context "blue " do
    ...
    it "can activate pawn 2" do
      ...
      expect(game_blue_start.selected_pawn.pos).to eq([0, 4])
      game_blue_start.destroy_pawns("b:2", [0, 4])
    end
    ...
    it "can destroy pawn at position" do
      ...
      expect(game_blue_start.board).to eq([[[], ["b:1"], [], [], ["b:0"], [] , [], [], [], ["r:0"], ["r:1"]],
                                          [["b:2"], ["b:3"], [], [], [], [], [], [], [], ["r:2"], ["r:3"]],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
      ...
      game_blue_start.destroy_pawns("b:0", [0, 4])
      expect(game_blue_start.selected_pawn.pos).to eq([0, 0])
      expect(game_blue_start.board).to eq([[["b:0"], ["b:1"], [], [], [], [] , [], [], [], ["r:0"], ["r:1"]],
                                          [["b:2"], ["b:3"], [], [], [], [], [], [], [], ["r:2"], ["r:3"]],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
    ...
    it "can move pawn" do
      ...
      game_blue_start.destroy_pawns("b:1", [6, 0])
    end
    ...
    it "can destroy pawn when stepped on it" do
      ...
      expect(game_blue_start.board).to eq([[["b:0"], [], [], [], [], [] , [], [], [], ["r:0"], ["r:1"]],
                                          ...
                                          [["y:0"], ["y:1"], [], [], [], [] , [], [], [], ["g:0"], ["g:1"]],
                                          [["y:2"], ["y:3"], [], [], [], [] , [], [], [], ["g:2"], ["g:3"]]])
      game_blue_start.destroy_pawns("b:1", [4, 4])
    end
    ...
    it "can activate 2 pawns at one position  and destroy them" do
      ...
      expect(game_blue_start.board).to eq([[["b:0"], [], [], [], ["b:1", "b:3"], [] , [], [], [], ["r:0"], ["r:1"]],
                                          [["b:2"], [], [], [], [], [], [], [], [], ["r:2"], ["r:3"]],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
      ...
      game_blue_start.destroy_pawns("b:3", [0, 4])
      expect(game_blue_start.board).to eq([[["b:0"], ["b:1"], [], [], [], [] , [], [], [], ["r:0"], ["r:1"]],
                                          [["b:2"], ["b:3"], [], [], [], [], [], [], [], ["r:2"], ["r:3"]],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
    ...
    it "can move 2 pawns to same position" do
      ...
      game_blue_start.destroy_pawns("b:1", [4, 4])
      game_blue_start.destroy_pawns("b:2", [4, 4])
    end
    ...
    it "can destroy 2 pawns when stepping on them" do
      ...
      game_blue_start.override_turn("player4")
      player4.last_roll = 6
      game_blue_start.select_pawn("r:1")
      game_blue_start.activate_selected_pawn
      ...
      expect(game_blue_start.board).to eq([[["b:0"], [], [], [], ["b:1", "b:3"], [] , [], [], [], ["r:0"], []],
                                          [["b:2"], [], [], [], [], [], [], [], [], ["r:2"], ["r:3"]],
                                          [[], [], [], [], [], [] , ["r:1"], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
      ...
      expect(game_blue_start.board).to eq([[["b:0"], ["b:1"], [], [], ["r:1"], [] , [], [], [], ["r:0"], []],
                                          [["b:2"], ["b:3"], [], [], [], [], [], [], [], ["r:2"], ["r:3"]],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
                                          [[], [], [], [], [], [] , [], [], [], [], []],
